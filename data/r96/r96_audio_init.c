    ...
    //LEVEL_WDW
{
    ...
    //LEVEL_FOURTH_FLOOR
    R96_EffectData[LEVEL_FOURTH_FLOOR][1].name = R96_LEVEL_FOURTH_FLOOR;
    R96_EffectData[LEVEL_FOURTH_FLOOR][1].roomSize = 1.0f/10.0f;
    R96_EffectData[LEVEL_FOURTH_FLOOR][1].damping = 0.25f;
    R96_EffectData[LEVEL_FOURTH_FLOOR][1].width = 1.0f;
    R96_EffectData[LEVEL_FOURTH_FLOOR][1].wetVolume = 0.1f;
    R96_EffectData[LEVEL_FOURTH_FLOOR][1].dryVolume = 0.5f;
    R96_EffectData[LEVEL_FOURTH_FLOOR][1].mode = 0.0f;
}
#endif